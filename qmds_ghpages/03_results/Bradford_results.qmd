---
title: "CAZ Results: Bradford"
---

## Overview

This page presents comprehensive analysis for the **Bradford** Clean Air Zone, including prescription trends and hospital admissions data. The analysis examines changes before and after CAZ implementation (2022), comparing practices and districts within and around the CAZ boundaries to control groups.
...
We plot hospital admissions for under-19-year-olds in Bradford, grouped by age. The plot includes a control line representing trends in non-CAZ districts for comparison.
...
admissions_plot <- caz_admissions_data |>
  ...
  labs(
    title = "Hospital Admissions for Under 19-years-olds - Bradford",
    y = "per 100,000",
    x = "Time Period",
    col = "Area"
  )
...
Detailed admissions data for Bradford:
...
This comprehensive analysis for Bradford presents both prescription trends and hospital admission outcomes in the context of Clean Air Zone implementation in 2022. The combination of prescription and health outcome data provides a multi-faceted view of potential CAZ impacts on respiratory health in the Bradford population.
