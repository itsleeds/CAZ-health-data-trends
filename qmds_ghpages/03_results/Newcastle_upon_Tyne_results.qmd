---
title: "CAZ Results: Newcastle upon Tyne"
---

## Overview

This page presents comprehensive analysis for the **Newcastle upon Tyne** Clean Air Zone, including prescription trends and hospital admissions data. The analysis examines changes before and after CAZ implementation (2023), comparing practices and districts within and around the CAZ boundaries to control groups.

**Note:** Data availability changes before and after the CAZ implementation date for Newcastle upon Tyne.
...
We plot hospital admissions for under-19-year-olds in Newcastle upon Tyne, grouped by age. The plot includes a control line representing trends in non-CAZ districts for comparison.
...
admissions_plot <- caz_admissions_data |>
  ...
  labs(
    title = "Hospital Admissions for Under 19-years-olds - Newcastle upon Tyne",
    y = "per 100,000",
    x = "Time Period",
    col = "Area"
  )
...
Detailed admissions data for Newcastle upon Tyne:
...
This comprehensive analysis for Newcastle upon Tyne presents both prescription trends and hospital admission outcomes in the context of Clean Air Zone implementation in 2023. The combination of prescription and health outcome data provides a multi-faceted view of potential CAZ impacts on respiratory health in the Newcastle population. Note the data availability changes around the CAZ implementation date.
